...
write.csv(imp_combined, file = "outputs/importance_estimates-rm-low-tp.csv")
...
write.csv(round(slopes_by_order, 3), file = "outputs/slopes_by_order-rm-low-tp.csv")
write.csv(round(slopes_by_ecoregion, 3), file = "outputs/slopes_by_ecoregion-rm-low-tp.csv")
