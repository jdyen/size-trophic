...
upper95tp <- read.csv("data/osm-data-upper95tp.csv", stringsAsFactors = FALSE)
...
# add in the upper95 TP data
idx <- match(sp_data$sp_code, upper95tp$SpecCode)
matched_tp95 <- upper95tp$upper95TP[idx]
sp_data$tl <- log10(matched_tp95)
...
save.image(file = "outputs/fitted-models-upper95tp.RData")
