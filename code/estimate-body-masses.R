...
elongation <- read.csv("data/raw-data-fish-elongation.csv", stringsAsFactors = FALSE)
body_mass <- read.csv("data/raw-data-by-species-with-body-mass.csv", stringsAsFactors = FALSE)
...
write.csv(data_sub, file = "data/data-with-imputed-mass.csv")
